...
Loss function designed for a network that infills collection view (unipolar) tracks. 
...
class DenseInfillLoss(nn.modules.loss._WeightedLoss):
    def __init__(self, weight=None, size_average=False, ignore_index=-100):
        super(DenseInfillLoss,self).__init__(weight,size_average)
